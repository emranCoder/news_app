      ...
      <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button onClick={props.btnCustomize} type="button" className="btn btn-lg btn-outline mx-2" data-toggle="tooltip" data-placement="bottom" title="Dark Mode on/off">
              <svg style={{ filter: props.mode === 'dark' ? 'invert(5)' : 'none' }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
